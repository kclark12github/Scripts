#RoboCopyMirror.ps1
#   RoboCopy Script to Mirror Provided Folders...
...
#=================================================================================================================================
#Notes to Self:
#This "Mirror" version should probably be rewritten into a generic RoboCopy shell script supporting both Mirror and Move, but I 
